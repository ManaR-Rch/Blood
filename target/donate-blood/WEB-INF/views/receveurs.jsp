...
<body>
    ...
    <h2>Receveurs enregist<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ page import="java.util.List" %>
<%@ page import="com.bloodbank.model.Receveur" %>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <p><a href="ajouter-receveur">Ajouter un nouveau receveur</a></p>
    <p><a href="home">Retour à l'accueil</a></p>
        ...
        <table border="1">
            ...
            <tr>
               ...
               <td><%= receveur.getTelephone() %></td>
                ...
                <td><%= (receveur.getDonneursAssocies() != null) 
 ? receveur.getDonneursAssocies().size() : 0 %></td>
                <td>
